    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <form className="flex flex-col items-center gap-4 w-full max-w-sm">
        ...
        <span className="w-full flex flex-col gap-2">
          <label htmlFor="firstName" className="text-green-500 font-semibold self-start">
            First Name
          </label>
          <input
            type="text"
        ...
        {/* Last Name */}
        <span className="w-full flex flex-col gap-2">
          <label htmlFor="lastName" className="text-green-500 font-semibold self-start">
            Last Name
          </label>
          <input
            type="text"
        ...
        {/* Confirm Password */}
        <span className="w-full flex flex-col gap-2">
          <label htmlFor="confirmPassword" className="text-green-500 font-semibold self-start">
            Confirm Password
          </label>
          <input
            type="password"
